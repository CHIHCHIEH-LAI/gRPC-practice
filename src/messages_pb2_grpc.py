...
class GreetingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/messages.GreetingService/SayHello',
...
def add_GreetingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'messages.GreetingService', rpc_method_handlers)
...
class GreetingService(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/messages.GreetingService/SayHello',
